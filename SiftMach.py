    ...
    def apply_sift_final(self, img_gray, img_rgb):
        ...
        for index_dis, key_desc_dis in enumerate(descriptors):  # dist = numpy.linalg.norm(a-b)
            for index_ic in range(index_dis + 1, len(keypoints_sift)):
                ...
                if dist < self.dist:
                    cv.circle(img_rgb, (point1_x, point1_y), 4, (0, 0, 255), -1)  # eslesen objeyi isaretlemek icin
                    ...
                    cv.circle(img_rgb, (point2_x, point2_y), 4, (255, 0, 0), -1)  # eslesen objeyi isaretlemek icin
                    ...
                    img_line = cv.line(img_rgb, (point1_x, point1_y), (point2_x, point2_y), (0, 255, 0), 1)
